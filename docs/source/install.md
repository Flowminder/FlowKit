...
The FlowAuth administration tool cannow be started at <a href="http://localhost:8000/" target="_blank">http://localhost:8000</a>. Log in with either `TEST_ADMIN:DUMMY_PASSWORD` or `TEST_USER:DUMMY_PASSWORD`.
