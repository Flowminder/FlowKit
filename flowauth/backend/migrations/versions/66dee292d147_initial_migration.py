...
def upgrade():
    ...
    op.create_table('scopes_in_role',
    ...
    op.create_table('users_with_roles',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('role_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['role_id'], ['role.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    ...
    with op.batch_alter_table('server', schema=None) as batch_op:
        batch_op.add_column(sa.Column('longest_token_life_minutes', sa.Integer(), nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('server', schema=None) as batch_op:
        batch_op.add_column(sa.Column('longest_token_life', sa.INTEGER(), nullable=False))
    ...
    op.create_table('group_server_permission',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('group_id', sa.INTEGER(), nullable=False),
    sa.Column('server_capability_id', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['group_id'], ['group.id'], ),
    sa.ForeignKeyConstraint(['server_capability_id'], ['server_capability.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('group_id', 'server_capability_id', name='_group_servercap_uc')
    )
    ...
    op.create_table('group_server_token_limits',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    op.create_table('server_capability',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('server_id', sa.INTEGER(), nullable=False),
