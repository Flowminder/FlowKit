...
<<<<<<< HEAD
- Added new `IntereventPeriod`, `ContactReciprocal`, `ProportionContactReciprocal`, `ProportionEventReciprocal`, `ProportionEventType`, `ContactModalLocationDistance` query classes to FlowMachine.
