...
- Added new `IntereventPeriod`, `ContactReciprocal`, `ProportionContactReciprocal`, `ProportionEventReciprocal`, `ProportionEventType`, `PerLocationEventCount`, `PerContactEventCount` query classes to FlowMachine.
