...
- Added new `ImputedDistanceSeries` query to Flowmachine, which produces contiguous per-subscriber time series of distance from a reference point by filling in gaps using the rolling median. [#1313](https://github.com/Flowminder/FlowKit/issues/1313)
