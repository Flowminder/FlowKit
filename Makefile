...
FLOWETL_SERVICES ?= flowetl_scheduler flowetl_db flowetl_redis flowetl_worker flowetl_webserver flowetl_flower flowetl_triggerer flowetl_init
DOCKER_SERVICES ?= flowdb flowapi flowmachine flowauth flowmachine_query_locker ${FLOWETL_SERVICES}  worked_examples
