...
"""
Tests for the class flowmachine_queries.TotalActivePeriodsSubscriber
"""
import pytest

from flowmachine_queries.features import TotalActivePeriodsSubscriber


def test_certain_results(get_dataframe):
    """
    flowmachine_queries.TotalActivePeriodsSubscriber gives correct results.
    """
...
def test_multiple_day_periods(get_dataframe):
    """
    flowmachine_queries.TotalActivePeriodsSubscriber can handle a period
...
def test_raises_value_error_bad_unit():
    """
    flowmachine_queries.TotalActivePeriodsSubscriber raises value error when
...
def test_non_standard_units(get_dataframe):
    """
    flowmachine_queries.TotalActivePeriodsSubscriber is able to handle a period_unit other
