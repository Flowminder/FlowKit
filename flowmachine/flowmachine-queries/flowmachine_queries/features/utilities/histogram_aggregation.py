...
class HistogramAggregation(Query):
    ...
    Examples
    --------
    >>>from flowmachine_queries.features import RadiusOfGyration
    >>>from flowmachine_queries.features.utilities.histogram_aggregation import HistogramAggregation
