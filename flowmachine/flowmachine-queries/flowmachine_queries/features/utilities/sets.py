...
from flowmachine_core.utility_queries.events_tables_union import EventsTablesUnion
from flowmachine_core.query_bases.query import Query
from flowmachine_core.core.context import get_db
from flowmachine_core.query_bases.spatial_unit import AnySpatialUnit, make_spatial_unit
...
class UniqueSubscribers(Query):
    ...
    table : str, default 'all'
        ...
        in them, specified via subscriber_tables in flowmachine_queries.yml. Otherwise
        you need to specify a full table (with a schema) such as
        'events.calls'.
    subscriber_identifier : {'msisdn', 'imei'}, default 'msisdn'
        Either msisdn, or imei, the column that identifies the subscriber.
    subscriber_subset : str, list, flowmachine_queries.core.Query, flowmachine_queries.core.Table, default None
...
class SubscriberLocationSubset(Query):
    ...
    spatial_unit : flowmachine_queries.core.spatial_unit.*SpatialUnit, default admin3
