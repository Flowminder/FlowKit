...
from flowmachine_core.utility_queries.join_to_location import location_joined_query
...
class SubscriberLocations(Query):
    ...
    stop : str
        As above
    spatial_unit : flowmachine_queries.core.spatial_unit.*SpatialUnit, default cell
    ...
    table : str, default 'all'
        ...
        specified as flowmachine_queries.yml under 'location_tables'
