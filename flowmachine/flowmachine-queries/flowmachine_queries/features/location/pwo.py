...
from flowmachine_queries.features.subscriber import daily_location
from flowmachine_core.utils import list_of_dates
from flowmachine_queries.features.subscriber import ModalLocation
from flowmachine_core.query_bases.spatial_unit import make_spatial_unit
from flowmachine_core.query_bases.spatial_unit import LonLatSpatialUnit
from flowmachine_queries.features.spatial.distance_matrix import DistanceMatrix

import structlog

logger = structlog.get_logger("flowmachine_queries.debug", submodule=__name__)
...
class _PopulationBuffer(Query):
    ...
    Parameters
    ----------
    population_object : flowmachine_queries.features.utilities.spatial_aggregate.SpatialAggregate
        An aggregated subscriber locating object
    distance_matrix : flowmachine_queries.features.spatial.distance_matrix.DistanceMatrix
        A distance matrix
    """
...
class PopulationWeightedOpportunities(Query):
    ...
    spatial_unit : flowmachine_queries.core.spatial_unit.*SpatialUnit, default versioned-site
    ...
    subscriber_subset : flowmachine_queries.core.Query, default None
