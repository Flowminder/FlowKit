...
class TotalNetworkObjects(GeoDataMixin, Query):
    ...
    network_object : flowmachine_queries.core.spatial_unit.*SpatialUnit, default cell
    ...
    spatial_unit : flowmachine_queries.core.spatial_unit.*SpatialUnit, default admin0
