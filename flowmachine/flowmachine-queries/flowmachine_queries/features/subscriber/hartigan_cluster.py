...
class HartiganCluster(BaseCluster):
    ...
    Parameters
    ----------
    calldays : flowmachine_queries.core.Query
    ...
    def join_to_cluster_components(self, query):
        ...
        Parameters
        ----------
        query : flowmachine_queries.Query
            A flowmachine_queries.Query object.
...
class _JoinedHartiganCluster(BaseCluster):
    ...
    Parameters
    ----------
    hartigan : flowmachine_queries.HartiganCluster
        A flowmachine_queries.HartiganCluster object on which we wish to join
