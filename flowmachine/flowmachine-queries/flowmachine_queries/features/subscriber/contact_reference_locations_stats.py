...
class ContactReferenceLocationStats(SubscriberFeature):
    ...
    Parameters
    ----------
    contact_balance: flowmachine_queries.features.ContactBalance
    ...
    contact_locations: flowmachine_queries.core.Query
        A flowmachine_queries Query instance that contains a subscriber column. In
