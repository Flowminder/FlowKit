...
from flowmachine_core.query_bases.model import Model, model_result
...
class Louvain(Model):
    ...
    `flowmachine_queries` feature (e.g. ContactBalance()).

    Parameters
    ----------
    graph : networkx.Graph() object
        This parameter specifies a networkx.Graph()
        object to use. This can be a `flowmachine_queries` feature
    ...
    >>> l = Louvain(
            flowmachine_queries.features.ContactBalance('2016-01-02', '2016-01-07').to_networkx(
