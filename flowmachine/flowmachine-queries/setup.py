...
# -*- coding: utf-8 -*-
"""
Setup configuration for `flowmachine_queries`.
...
setup(
    name="flowmachine-queries",
    version=versioneer.get_version(),
    cmdclass=versioneer.get_cmdclass(),
    entry_points={
        "flowkit.queries": [
            "flowmachine_queries = flowmachine_queries.query_schemas:schemas"
        ],
    },
    description="Digestion program for Call Detail Record (CDR) data.",
    long_description=readme,
    py_module=["flowmachine_queries"],
    author=__author__,
