...
"""
Tests for flowmachine_core small helper functions
"""
import pytest
import pglast

from flowmachine_core.core.context import get_db
from flowmachine_core.utils import *
from flowmachine_core.utils import _makesafe
...
def test_time_period_add():
    """
    flowmachine_core.utils.time_period_add does what it says on the tin.
    """
...
def test_time_period_add_other_units():
    """
    flowmachine_core.utils.time_period_add can also add hours and minutes
    """
