...
The heart of flowmachine_core is the AbstractBaseClass Query, which defines how an
...
from flowmachine_core.core.init import connect, connections
from flowmachine_core.core.logging import init_logging

methods = ["connect", "connections"]
sub_modules = ["core", "utils"]
__all__ = methods + sub_modules

# Initialise loggers when flowmachine_core is imported
init_logging()
