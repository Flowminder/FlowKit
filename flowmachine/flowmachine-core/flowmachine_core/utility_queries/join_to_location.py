...
from flowmachine_core.query_bases.spatial_unit import (
    SpatialUnitMixin,
    AnySpatialUnit,
    GeomSpatialUnit,
)
...
class JoinToLocation(Query):
    ...
    left : flowmachine_core.Query
        ...
        call 'location_id'.
    spatial_unit : flowmachine_core.core.spatial_unit.*SpatialUnit
    ...
    flowmachine_core/docs/source/notebooks/working_with_locations.ipynb
    ...
    def __init__(
        self, left: Query, *, spatial_unit: GeomSpatialUnit, time_col: str = "datetime"
    ):
