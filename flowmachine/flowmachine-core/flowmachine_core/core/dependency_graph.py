...
from flowmachine_core.core.errors import UnstorableQueryError
...
def print_dependency_tree(
    ...
    """
    Print the dependencies of a flowmachine_core query in a tree-like structure.
...
def calculate_dependency_graph(query_obj: "Query", analyse: bool = False) -> nx.DiGraph:
    ...
    >>> import flowmachine
    >>> from flowmachine_core.features import daily_location
