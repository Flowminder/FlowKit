...
from flowmachine_core.core.query_state import QueryStateMachine, QueryEvent
...
def write_cache_metadata(
    ...
    """
    Helper function for store, updates flowmachine_core metadata table to
...
def reset_cache(
    ...
    In addition, you should restart any interpreter running flowmachine_core after this command is run
