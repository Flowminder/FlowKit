...
class PolygonSpatialUnit(GeomSpatialUnit):
    ...
    geom_table : str or flowmachine_core.Query
        Name of the table containing the geography information.
        Can be either the name of a table, with the schema, or a
        flowmachine_core.Query object.
    geom_column : str, default 'geom'
...
def versioned_cell_spatial_unit() -> LonLatSpatialUnit:
    ...
    Returns
    -------
    flowmachine_core.core.spatial_unit.LonLatSpatialUnit
    """
...
def admin_spatial_unit(
    *, level: int, region_id_column_name: Optional[str] = None
    ...
    Returns
    -------
    flowmachine_core.core.spatial_unit.PolygonSpatialUnit
...
def make_spatial_unit(
    ...
    *,
    ...
    geom_table : str or flowmachine_core.Query
        ...
        the name of a table, with the schema, or a flowmachine_core.Query object.
        Required when spatial_unit_type='polygon'.
    geom_column : str, default 'geom'
        Name of the column in geom_table that defines the geography.
        Required when spatial_unit_type='polygon'.
