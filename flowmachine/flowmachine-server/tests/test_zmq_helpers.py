...
from flowmachine_server.server import (
    get_reply_for_message,
    calculate_and_send_reply_for_message,
)
from flowmachine_server.zmq_helpers import *
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Internal flowmachine-queries-server server error: wrong arguments passed to handler for action 'ping'.",
        ),
    ],
)
@pytest.mark.asyncio
...
async def test_generic_error_catch(server_config):
    ...
    with patch("flowmachine_server.server.get_reply_for_message") as mock_get_reply:
