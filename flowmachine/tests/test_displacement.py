...
def test_pass_modal_location(get_dataframe):
    ...
    ml = ModalLocation(
        *[
            daily_location(d, spatial_unit=make_spatial_unit("lat-lon"))
...
def test_error_when_modal_location_not_latlong():
    ...
    is not using lat-lon spatial unit
    """
...
def test_get_all_users_in_modal_location(get_dataframe):
    ...
    ml = ModalLocation(
        *[
            daily_location(d, spatial_unit=make_spatial_unit("lat-lon"), hours=(12, 13))
