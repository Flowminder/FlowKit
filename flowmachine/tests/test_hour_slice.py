...
from flowmachine.core.hour_slice import HourOfDay, HourSlice, MultipleHourSlices
...
def test_daily_hour_slice_without_start_hour():
    hs = HourSlice(start_hour=None, stop_hour="17:50", freq="day")
...
def test_daily_hour_slice_without_stop_hour():
    hs = HourSlice(start_hour="07:20", stop_hour=None, freq="day")
...
def test_weekly_hour_slice_without_start_value():
    hs = HourSlice(start_hour=None, stop_hour="16:38", freq="week", weekday="Wednesday")
    assert hs.start_hour == None
...
def test_weekly_hour_slice_without_stop_value():
    hs = HourSlice(start_hour="10:00", stop_hour=None, freq="week", weekday="Saturday")
