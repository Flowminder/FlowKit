...
def test_redacted_trips_counts(get_dataframe):
    """
    Values test for redacted  trips counts.
    """
    trips = RedactedTripsODMatrix(
        trips=TripsODMatrix(
            subscriber_locations=SubscriberLocations(
                "2016-01-01 13:30:30", "2016-01-07 16:25:00"
            )
    ...
    with pytest.raises(KeyError):
        df.loc["3zvL9X9P", "w0FuUW7j"].value
