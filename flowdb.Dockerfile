...
FROM postgres@sha256:b0cfe264cb1143c7c660ddfd5c482464997d62d6bc9f97f8fdf3deefce881a8c


ARG POSTGIS_MAJOR=3
ENV POSTGIS_MAJOR=$POSTGIS_MAJOR
ARG POSTGIS_VERSION=3.0.2+dfsg-2.pgdg100+1
ARG PGROUTING_VERSION=3.1.0-1.pgdg100+1
ARG PG_MEDIAN_UTILS_VERSION=0.0.7
ARG OGR_FDW_VERSION=1.0.12-1.pgdg100+1
...
RUN apt update && apt install -y curl && \
    ...
    apt remove -y bazel git bison postgresql-server-dev-$PG_VERSION libreadline-dev flex curl && \
